...
step_model_both <- stepAIC(linear_model_initial, direction = "both", scope = list(upper = . ~ ., lower = ~ 1))
...
step_model_backward <- stepAIC(linear_model_initial, direction = "backward")
...
step_model_forward <- stepAIC(linear_model_initial, direction = "forward", scope = list(upper = . ~ ., lower = ~ 1))
