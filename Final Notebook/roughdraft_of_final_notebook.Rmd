...
if (update_model_parameters) {
  ...
  # Step model both
  step_model_both <- ols_step_both_p(linear_model_initial, pent=0.35, prem=0.05)
  features_both <- setdiff(names(coef(step_model_both$model)), "(Intercept)")
  ...
  features_backward <- setdiff(names(coef(step_model_backward$model)), "(Intercept)")
  ...
  features_forward <- setdiff(names(coef(step_model_forward$model)), "(Intercept)")
