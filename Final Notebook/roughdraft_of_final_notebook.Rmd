...
# Create a data frame with the column names and VIF values
vif_data <- data.frame(
  "Column Name" = c("day_of_year", "grade_5", "grade_6", "grade_7", "grade_8", "grade_9", "grade_10", "grade_11", "season_Summer", "season_Fall", "distance_to_convergence"),
  "VIF Value" = c(18.74, 20.76, 166.84, 454.88, 371.93, 195.81, 88.27, 33.39, 11.73, 21.83, 20.05)
)

# Create a figure caption using the custom function
caption <- generate_figure_caption("Variable Inflation Factors (VIF) Table")

# Generate the kable table
kable(vif_data, format = "html", caption = caption)
...
# View the updated model results
view_model_results(df_results, caption = "Weighted Least Squares Model")
```
