...
author: " Charles Atchison <br> Jussan Da Silva Bahia Nascimento"
date: "`r Sys.Date()`"
output:
  html_document:
    fig_caption: true
...
required_packages <- c(
  ...
  "RColorBrewer", "scales", "purrr", "DT", "jsonlite", "magrittr", "rpart", "broom", "pscl"
)
...
# Navigate up one directory and then to the CSV datafile
...
#### 9.4.2 Data Structure and Summary
...
#### 9.4.4 Binary Logistic Regression
...
#### 9.4.5 Deviance and Hypothesis Testing
...
#### 9.4.6 Stepwise Selection with AIC
...
#### 9.4.7 Stepwise Logistic Regression Model Performance
...
#### 9.4.8 Training Dataset Metrics
