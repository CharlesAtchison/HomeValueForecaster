...
get_dropped_features_table <- function(model_backward, model_forward, model_both, train_df_linear) {
  ...
  dropped_both <- get_dropped_features(model_both, all_possible_features)
...
if (update_model_parameters) {
  ...
  model_both <- lm(formula, data = train_df_linear)
...
dropped_features_table <- get_dropped_features_table(model_backward, model_forward, model_both, train_df_linear)
```
...
best_linear_model <- linear_model_initial
```
