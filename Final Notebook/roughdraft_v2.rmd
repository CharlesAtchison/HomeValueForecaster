...
### 5.7 Removal of Plot Features and Multicollinearity
...
coefficients_df <- create_coefficients_df(
  ...
  model_name = "Initial OLS Model High Corr Cols Removed",
...
coefficients_df <- create_coefficients_df(
  ...
  model_name = "Inital Step Both (best model)",
  coefficients_df = coefficients_df
)
...
coefficients_df <- create_coefficients_df(
  model = best_linear_model,
  model_name = "Inital Step Both (best model) Outliers Removed",
  coefficients_df = coefficients_df
)
```
...
coefficients_df <- create_coefficients_df(
  ...
  model_name = "Weighted Transformed Model",
  coefficients_df = coefficients_df
)
```
...
df_results <- rbind(df_results, data.frame(
  Model = "Weighted Transformed Model 2000 iterations",
  SSE_train = SSE_train,
  SSE_test = SSE_test,
  R_squared_train = R_squared_train,
  R_squared_test = R_squared_test,
...
coefficients_df <- create_coefficients_df(
  model = transformed_model_weighted,
  model_name = "Weighted Transformed Model 200 Iterations",
  coefficients_df = coefficients_df
)
...
model_names_to_match <- c("Weighted Transformed Model", "Weighted Transformed Model 200 Iterations")
...
datatable(selected_rows, caption = generate_table_caption("Selected Rows Without NA Columns", section = 8))
```
...
model_names_to_match <- c("Ridge Model", "Weighted Transformed Model 200 Iterations")
...
# Display the selected rows without columns containing NA values in a scrollable dataframe
datatable(selected_rows, caption = generate_table_caption("Ridge and OLS model comparison", section = 8))
```
...
model_names_to_match <- c("Lasso Model", "Weighted Transformed Model 200 Iterations")
...
# Display the selected rows without columns containing NA values in a scrollable dataframe
datatable(selected_rows, caption = generate_table_caption("Lasso and OLS model comparison", section = 8))
```
...
model_names_to_match <- c("Elastic Net Model", "Weighted Transformed Model 200 Iterations")
...
# Display the selected rows without columns containing NA values in a scrollable dataframe
datatable(selected_rows, caption = generate_table_caption("Elastic Net and OLS model comparison", section = 8))
```
...
model_names_to_match <- c("Huber Model", "Weighted Transformed Model 200 Iterations")
...
# Display the selected rows without columns containing NA values in a scrollable dataframe
datatable(selected_rows, caption = generate_table_caption("Huber and OLS model comparison", section = 8))
```

### 8. Coefficients Examination

```{r}
# Assuming linear_model_initial and transformed_model are linear model objects you have fitted
datatable(selected_rows, caption = generate_table_caption("All Model Coefficients", section = 8))
```
